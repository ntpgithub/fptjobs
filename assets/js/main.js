...
//Swap Modal
function swapModaltoLogin1() {
  var modal1 = document.getElementById("ModalRegister");
  var bsModal1 = bootstrap.Modal.getInstance(modal1);
  if (bsModal1) {
    bsModal1.hide();
  } else {
    bsModal1 = new bootstrap.Modal(modal1);
    bsModal1.hide();
  }
  modal1.addEventListener(
    "hidden.bs.modal",
    function () {
      var modal2 = new bootstrap.Modal(document.getElementById("ModalLogin"));
      modal2.show();
    },
    { once: true }
  );
...
function swapModaltoRegister() {
  var modal1 = document.getElementById("ModalLogin");
  var bsModal1 = bootstrap.Modal.getInstance(modal1);
  if (bsModal1) {
    bsModal1.hide();
  } else {
...
function swapModaltoLogin2() {
  var modal1 = document.getElementById("ModalPassword");
  var bsModal1 = bootstrap.Modal.getInstance(modal1);
  if (bsModal1) {
    bsModal1.hide();
  } else {
